...
alpha0w<-matrix(data=data[1,2],nrow=nScenarios,ncol=nPeriods)            #Autonomous consumption of workers
alpha0z<-matrix(data=data[2,2],nrow=nScenarios,ncol=nPeriods)            #Autonomous consumption of capitalists
alpha1w<-matrix(data=0,nrow=nScenarios,ncol=nPeriods)                    #Propensity to consume out of wages
alpha1z<-matrix(data=0,nrow=nScenarios,ncol=nPeriods)                    #Propensity to consume out of profits 
r_bar<-matrix(data=0.02,nrow=nScenarios,ncol=nPeriods)                   #Policy rate

#Define 2D variables as matrices ####
yg<-matrix(data=data[6,2],nrow=nScenarios,ncol=nPeriods)                 #Nominal gross output
yn<-matrix(data=data[7,2],nrow=nScenarios,ncol=nPeriods)                 #Nominal net output (or net income or value added)
c<-matrix(data=data[17,2],nrow=nScenarios,ncol=nPeriods)                 #Total nominal consumption
cw<-matrix(data=data[18,2],nrow=nScenarios,ncol=nPeriods)                #Real consumption of workers
cz<-matrix(data=data[19,2],nrow=nScenarios,ncol=nPeriods)                #Real consumption of rentiers
id<-matrix(data=data[20,2],nrow=nScenarios,ncol=nPeriods)                #Real investment
da<-matrix(data=data[21,2],nrow=nScenarios,ncol=nPeriods)                #Real depreciation of capital
af<-matrix(data=data[22,2],nrow=nScenarios,ncol=nPeriods)                #Amortization funds
pw<-matrix(data=data[38,2],nrow=nScenarios,ncol=nPeriods)                #Average price of workers' consumption
pz<-matrix(data=data[39,2],nrow=nScenarios,ncol=nPeriods)                #Average price of rentiers' consumption
pid<-matrix(data=data[40,2],nrow=nScenarios,ncol=nPeriods)               #Average price of investment
ydw<-matrix(data=data[50,2],nrow=nScenarios,ncol=nPeriods)               #Disposable income of workers
wb<-matrix(data=data[51,2],nrow=nScenarios,ncol=nPeriods)                #Wage bill
paymw_m<-matrix(data=data[52,2],nrow=nScenarios,ncol=nPeriods)           #Interest payments on deposits held by workers
paymw_b<-matrix(data=data[53,2],nrow=nScenarios,ncol=nPeriods)           #Interest payments on securities held by workers       
paym_l<-matrix(data=data[54,2],nrow=nScenarios,ncol=nPeriods)            #Interest payments on loans       
ydz<-matrix(data=data[55,2],nrow=nScenarios,ncol=nPeriods)               #Disposable income of capitalists
pb<-matrix(data=data[56,2],nrow=nScenarios,ncol=nPeriods)                #Profit of banks
pf<-matrix(data=data[57,2],nrow=nScenarios,ncol=nPeriods)                #Profit of firms
paymz_m<-matrix(data=data[58,2],nrow=nScenarios,ncol=nPeriods)           #Interest payments on deposits held by rentiers
paym_m<-matrix(data=data[59,2],nrow=nScenarios,ncol=nPeriods)            #Total interest payments on deposits
paymz_b<-matrix(data=data[60,2],nrow=nScenarios,ncol=nPeriods)           #Interest payments on securities held by rentiers 
paym_b<-matrix(data=data[61,2],nrow=nScenarios,ncol=nPeriods)            #Total interest payments on securities 
yd<-matrix(data=data[62,2],nrow=nScenarios,ncol=nPeriods)                #Total disposable income
vw<-matrix(data=data[63,2],nrow=nScenarios,ncol=nPeriods)                #Net wealth of workers
vz<-matrix(data=data[64,2],nrow=nScenarios,ncol=nPeriods)                #Net wealth of rentiers
vh<-matrix(data=data[65,2],nrow=nScenarios,ncol=nPeriods)                #Total net wealth
bw<-matrix(data=data[66,2],nrow=nScenarios,ncol=nPeriods)                #Demand for private securities by workers
mw<-matrix(data=data[67,2],nrow=nScenarios,ncol=nPeriods)                #Bank deposits held by workers by workers
bz<-matrix(data=data[68,2],nrow=nScenarios,ncol=nPeriods)                #Demand for private securities by capitalists
mz<-matrix(data=data[69,2],nrow=nScenarios,ncol=nPeriods)                #Bank deposits held by workers by capitalists
bh<-matrix(data=data[70,2],nrow=nScenarios,ncol=nPeriods)                #Total demand for private securities
mh<-matrix(data=data[71,2],nrow=nScenarios,ncol=nPeriods)                #Total bank deposits held by workers
bs<-matrix(data=data[72,2],nrow=nScenarios,ncol=nPeriods)                #Supply private securities
k<-matrix(data=data[73,2],nrow=nScenarios,ncol=nPeriods)                 #Real stock of fixed capital  
kt<-matrix(data=data[74,2],nrow=nScenarios,ncol=nPeriods)                #Target stock of capital  
kn<-matrix(data=data[75,2],nrow=nScenarios,ncol=nPeriods)                #Nominal value of capital stock  
fin_i<-matrix(data=data[76,2],nrow=nScenarios,ncol=nPeriods)             #Initial finance             
fin_f<-matrix(data=data[77,2],nrow=nScenarios,ncol=nPeriods)             #Final finance
ld<-matrix(data=data[78,2],nrow=nScenarios,ncol=nPeriods)                #Demand for loans  
ls<-matrix(data=data[79,2],nrow=nScenarios,ncol=nPeriods)                #Supply of loans
ms<-matrix(data=data[80,2],nrow=nScenarios,ncol=nPeriods)                #Supply of deposits
rm<-matrix(data=data[81,2],nrow=nScenarios,ncol=nPeriods)                #Interest rate on deposits
rl<-matrix(data=data[82,2],nrow=nScenarios,ncol=nPeriods)                #Interest rate on loans
rb<-matrix(data=data[83,2],nrow=nScenarios,ncol=nPeriods)                #Rate of return on securities  
n<-matrix(data=data[87,2],nrow=nScenarios,ncol=nPeriods)                 #Demand for labour (employment)
q<-matrix(data=data[91,2],nrow=nScenarios,ncol=nPeriods)                 #Tobin's q
pbs<-matrix(data=data[92,2],nrow=nScenarios,ncol=nPeriods)               #Price of private securities
bsr<-matrix(data=data[93,2],nrow=nScenarios,ncol=nPeriods)               #Quantity of private securities issued by the firms
bwr<-matrix(data=data[94,2],nrow=nScenarios,ncol=nPeriods)               #Quantity of private securities held by the workers
bzr<-matrix(data=data[95,2],nrow=nScenarios,ncol=nPeriods)               #Quantity of private securities held by the rentiers
bhr<-matrix(data=data[96,2],nrow=nScenarios,ncol=nPeriods)               #Quantity of private securities held by the households
cgw<-matrix(data=data[97,2],nrow=nScenarios,ncol=nPeriods)               #Workers' capital gains on firms' securities 
cgz<-matrix(data=data[98,2],nrow=nScenarios,ncol=nPeriods)               #Rentiers' capital gains on firms' securities 
lev<-matrix(data=0.964,nrow=nScenarios,ncol=nPeriods)                    #Normalised leverage ratio (Minsky-like)
kappaM<-matrix(data=data[20,2],nrow=nScenarios,ncol=nPeriods)            #Sensitivity of investment to deviations of q from 1
mul<-matrix(data=0.01,nrow=nScenarios,ncol=nPeriods)                     #Risk premium on loans
mul1<-matrix(data=0,nrow=nScenarios,ncol=nPeriods)                       #Elasticity of risk to leverage ratio
mul0<-matrix(data=-0.05,nrow=nScenarios,ncol=nPeriods)                   #Risk premium on loans: autonomous component (note: negative to allow for a higher mul1)
test<-matrix(data=0,nrow=nScenarios,ncol=nPeriods)
...
I_col<-matrix(data=1,nrow=nScenarios,ncol=nPeriods)              #Column vector of 1s

#Define 3D variables as arrays ####
kappa<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))      #Target capital to output ratios
x<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))          #Real gross output
xN<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))         #Natural output
phi<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))        #Speed of adjustment of natural output to current one
d<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))          #Final demand in real terms
p<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))          #Unit prices
betaw<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))      #Shares of real consumption of workers
betaz<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))      #Shares of real consumption of rentiers
iota<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))       #Shares of real investment in fixed capital
pr<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))         #Vector of labour productivities
mup<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))        #Vector of markups
mup0<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))       #Vector of initial markups
mup1<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))       #Vector of sensitivities of markups to output gaps
fin_i_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))    #Initial finance in each industry             
fin_f_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))    #Final finance in each industry
pf_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))       #Firms profit in each industry
cost_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))     #Total cost in each industry
rev_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))      #Total revenue in each industry
k_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))        #Real capital stock in each industry
kt_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))       #Target capital stock in each industry
id_j<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))       #Real investment in each industry
gamma0<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))     #Subjective expectations component in investment decisions
wd<-array(data=0,dim=c(nScenarios,nPeriods,nIndustries))         #Share of industry-related value added to total value added
...
pbar <- progress_bar$new( total = nScenarios * nPeriods,
...
for (i in 2:(nPeriods-1)){error = error + (ms[j,i]-mw[j,i]-mz[j,i])^2}
...
year_breaks <- seq(1, nPeriods, by = 4)  
year_labels <- seq(0, (nPeriods - 1) / 4)
...
#Plot 1
plot(mh[1,40:nPeriods]-ms[1,40:nPeriods],type="l",col=6,ylim=range(-1,1),font.main=1,main="a) Consistency check: \n hidden equation",ylab = '$',xlab = 'Years', xaxt = 'n')
axis(1, at = year_breaks*10, labels = year_labels*10)
lines(mh[2,40:nPeriods]-ms[2,40:nPeriods],col=6)
lines(mh[3,40:nPeriods]-ms[3,40:nPeriods],col=6)
...
#Plot 2
plot(yn[2,40:nPeriods], type="l", col=2, font.main=1,
     main="b) Net value added", ylab = '$', xlab = 'Years',
     ylim=range(min(yn[3,40:nPeriods],yn[4,40:nPeriods]),max(yn[3,40:nPeriods],yn[4,40:nPeriods])), xaxt = 'n')
lines(yn[3,40:nPeriods], col=4)
lines(yn[4,40:nPeriods], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 3
plot(d[2,40:nPeriods,1],type="l",col=2,font.main=1,
     main="c) Real dem. for consumer goods",ylab = 'Index',xlab = 'Years',
     ylim=range(min(d[3,40:nPeriods,1],d[4,40:nPeriods,1]),max(d[3,40:nPeriods,1],d[4,40:nPeriods,1])), xaxt = 'n')
lines(d[3,40:nPeriods,1],col=4)
lines(d[4,40:nPeriods,1], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 4
plot(d[2,40:nPeriods,2],type="l",col=2,font.main=1,
     main="d) Real dem. for luxury goods",ylab = 'Index',xlab = 'Years',
     ylim=range(min(d[4,40:nPeriods,2],d[2,40:nPeriods,2]),max(d[4,40:nPeriods,2],d[2,40:nPeriods,2])), xaxt = 'n')
lines(d[3,40:nPeriods,2],col=4)
lines(d[4,40:nPeriods,2], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 5
plot(d[2,40:nPeriods,3],type="l",col=2,font.main=1,
     main="e) Real dem. for investment goods",ylab = 'Index',xlab = 'Years',
     ylim=range(min(d[3,40:nPeriods,3],d[4,40:nPeriods,3]),max(d[3,40:nPeriods,3],d[4,40:nPeriods,3])), xaxt = 'n')
lines(d[3,40:nPeriods,3],col=4)
lines(d[4,40:nPeriods,3], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 6
plot(x[2,40:nPeriods,1],type="l",col=2,font.main=1,
     main="f) Gross output: consumer goods",ylab = 'Index',xlab = 'Years',
     ylim=range(min(x[4,40:nPeriods,1],x[2,40:nPeriods,1]),max(x[4,40:nPeriods,1],x[2,40:nPeriods,1])), xaxt = 'n')
lines(x[3,40:nPeriods,1],col=4)
lines(x[4,40:nPeriods,1], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 7
plot(x[2,40:nPeriods,2],type="l",col=2,font.main=1,
     main="g) Gross output: luxury goods",ylab = 'Index',xlab = 'Years',
     ylim=range(min(x[4,40:nPeriods,2],x[3,40:nPeriods,2]),max(x[4,40:nPeriods,2],x[3,40:nPeriods,2])), xaxt = 'n')
lines(x[3,40:nPeriods,2],col=4)
lines(x[4,40:nPeriods,2], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 8
plot(x[2,40:nPeriods,3],type="l",col=2,font.main=1,
     main="h) Gross output: investment goods",ylab = 'Index',xlab = 'Years',
     ylim=range(min(x[4,40:nPeriods,3],x[3,40:nPeriods,3]),max(x[4,40:nPeriods,3],x[2,40:nPeriods,3])), xaxt = 'n')
lines(x[3,40:nPeriods,3],col=4)
lines(x[4,40:nPeriods,3], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 9
plot(id[2,40:nPeriods],type="l",col=2,font.main=1,
     main="i) Investment in fixed capital",ylab = '$',xlab = 'Years',
     ylim=range(min(id[4,40:nPeriods],id[3,40:nPeriods]),max(id[4,40:nPeriods],id[3,40:nPeriods])), xaxt = 'n')
lines(id[3,40:nPeriods],col=4)
lines(id[4,40:nPeriods], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 10
plot(100*rl[2,40:nPeriods],type="l",col=2,font.main=1,
     main="j) Interest rate on loans",ylab = '%',xlab = 'Years',
     ylim=range(min(100*rl[4,40:nPeriods],100*rl[3,40:nPeriods]),max(100*rl[4,40:nPeriods],100*rl[3,40:nPeriods])), xaxt = 'n')
lines(100*rl[3,40:nPeriods],col=4)
lines(100*rl[4,40:nPeriods], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 11
plot(lev[2,40:nPeriods]-lev[1,40:nPeriods],type="l",col=2,font.main=1,
     main="k) Leverage rate",ylab = 'Index (change)',xlab = 'Years',
     ylim=range(min(lev[4,40:nPeriods]-lev[1,40:nPeriods],lev[3,40:nPeriods]-lev[1,40:nPeriods]),max(lev[4,40:nPeriods]-lev[1,40:nPeriods],lev[3,40:nPeriods]-lev[1,40:nPeriods])), xaxt = 'n')
lines(lev[3,40:nPeriods]-lev[1,40:nPeriods],col=4)
lines(lev[4,40:nPeriods]-lev[1,40:nPeriods], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 12
plot(q[2,40:nPeriods]-q[1,40:nPeriods],type="l",col=2,font.main=1,
     main="l) Minsky's price ratio",ylab = 'Index (change)',xlab = 'Years',
     ylim=range(min(q[4,40:nPeriods]-q[1,40:nPeriods],q[3,40:nPeriods]-q[1,40:nPeriods]),max(q[4,40:nPeriods]-q[1,40:nPeriods],q[3,40:nPeriods]-q[1,40:nPeriods])), xaxt = 'n')
lines(q[3,40:nPeriods]-q[1,40:nPeriods],col=4)
lines(q[4,40:nPeriods]-q[1,40:nPeriods], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 13
plot(fin_i[2,40:nPeriods],type="l",col=2,font.main=1,
     main="m) Initial and final finance: total",ylab = '$',xlab = 'Years',
     ylim=range(min(fin_i[2,40:nPeriods],fin_i[3,40:nPeriods]),max(fin_i[2,40:nPeriods],fin_i[3,40:nPeriods])), xaxt = 'n')
lines(fin_i[3,40:nPeriods],col=4)
lines(fin_f[2,40:nPeriods],col="darkred", lty=2)
lines(fin_f[3,40:nPeriods],col="midnightblue", lty=2)
axis(1, at = year_breaks*10, labels = year_labels*10)
...
#Plot 14
plot(fin_i_j[2,40:nPeriods,1],type="l",col=2,font.main=1,
     main="n) Initial finance: consumer goods",ylab = '$',xlab = 'Years',
     ylim=range(min(fin_i_j[4,40:nPeriods,1],fin_i_j[3,40:nPeriods,1]),max(fin_i_j[4,40:nPeriods,1],fin_i_j[2,40:nPeriods,1])), xaxt = 'n')
lines(fin_i_j[3,40:nPeriods,1],col=4)
lines(fin_i_j[4,40:nPeriods,1], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 14
plot(fin_i_j[2,40:nPeriods,2],type="l",col=2,font.main=1,
     main="o) Initial finance: luxury goods",ylab = '$',xlab = 'Years',
     ylim=range(min(fin_i_j[4,40:nPeriods,2],fin_i_j[3,40:nPeriods,2]),max(fin_i_j[4,40:nPeriods,2],fin_i_j[2,40:nPeriods,2])), xaxt = 'n')
lines(fin_i_j[3,40:nPeriods,2],col=4)
lines(fin_i_j[4,40:nPeriods,2], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)

#Plot 15
plot(fin_i_j[2,40:nPeriods,3],type="l",col=2,font.main=1,
     main="p) Initial finance: investment goods",ylab = '$',xlab = 'Years',
     ylim=range(min(fin_i_j[4,40:nPeriods,3],fin_i_j[3,40:nPeriods,3]),max(fin_i_j[4,40:nPeriods,3],fin_i_j[2,40:nPeriods,3])), xaxt = 'n')
lines(fin_i_j[3,40:nPeriods,3],col=4)
lines(fin_i_j[4,40:nPeriods,3], col=mycol3)
axis(1, at = year_breaks*10, labels = year_labels*10)
legend("bottom",c("Graziani","Minsky","Minsky plus"),  bty = 'n', cex=1, lty=c(1,1,1), lwd=c(1,1), col = c(2,4,mycol3), box.lty=0)
